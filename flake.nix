{
  inputs = {
    ...
    zen-browser = {
      url = "github:goggi/zen-twilight-flake";
      inputs.nixpkgs.follows = "nixpkgs";
    };

    catppuccin.url = "github:catppuccin/nix";
    lug.url =
      "github:LovingMelody/lug-helper/20806da463f9e069fdf98841ca2c5d69146cb163";
  ...
  outputs =
    { self, nixpkgs, sops-nix, hyprland, catppuccin, zen-browser, ... }@inputs:
    let
      system = "x86_64-linux";
      lib = nixpkgs.lib;
