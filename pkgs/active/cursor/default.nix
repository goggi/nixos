{
  ...
  src = fetchurl {
    url = "https://downloader.cursor.sh/linux/appImage/x64?v=${version}";
  ...
  stdenvNoCC.mkDerivation {
    ...
    installPhase = ''
      ...
      wrapProgram $out/bin/cursor \
        --add-flags "\''${NIXOS_OZONE_WL:+\''${WAYLAND_DISPLAY:+--ozone-platform-hint=auto --ozone-platform=wayland --enable-features=UseOzonePlatform,WaylandWindowDecorations}} --no-update"
